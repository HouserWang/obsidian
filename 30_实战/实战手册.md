...
---
## 🔗 关联笔记
- [[ddd-mvc转ddd]] — DDD 战术设计的代码实战
- [[ddd-极简战略设计实战]] — DDD 战略设计的事件风暴实战
- [[Java Agent 监控体系]] — SkyWalking/Prometheus 监控体系详解
- [[redis读写brag]] — Redis 缓存架构的完整 brag
- [[秒杀与库存]] — 高并发场景的 Redis + MQ 实战方案
- [[工作中使用ai]] — AI 辅助开发工具推荐
